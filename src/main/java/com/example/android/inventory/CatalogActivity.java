...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insetProduct() {
        ...
        values.put(ProductEntry.PRODUCT_NAME, "Toto");
        values.put(ProductEntry.PRICE, 100);
        values.put(ProductEntry.QUANTITY, 5);
        values.put(ProductEntry.SUPPLIER_PHONE_NUMBER, "9810685657");
        values.put(ProductEntry.SUPPLIER_NAME, "TSISAROCKSTAR");
